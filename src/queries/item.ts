...
export const GET_ALL_ITEMS: RequestDocument = graphql(`
  query getAllItems {
    items {
      id
      nft {
...
export const GET_ITEM_BY_NFT_TOKEN_ID: RequestDocument = graphql(`
  query getItemByNFTTokenId($tokenId: BigInt!) {
